...
```
### SQL OUTPUT
![alt text](https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q2.png)

### EXCEL OUTPUT
<img src="https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q2-G1.png" alt="alt text" width="750"/>
...
where
     ...
     to_char(order_approved_at, 'MM') = '12' --for new year/christmas
group by 1,2
)
select * from special_days where rn between 1 and 5;
```
### SQL OUTPUT
![alt text](https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q3.png)

### EXCEL OUTPUT
<img src="https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q3-G.png" alt="alt text" width="750"/>
...
```
### SQL OUTPUT
![alt text](https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q4.png)

### EXCEL OUTPUT
<img src="https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q4-G.png" alt="alt text" width="700"/>
...
```
### SQL OUTPUT
![alt text](https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q5.png)

### EXCEL OUTPUT
<img src="https://github.com/hilalguleryuz/postgresql_olist_data_analysis_project/blob/main/Case-1%3A%20Order%20Analysis/Case1/Case1-Q5-G.png" alt="alt text" width="750"/>
